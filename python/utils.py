...
#Evaluates on 500 negatively sampled items + target item, uniform sampling (Original pytorch implementation sampled 100)
def evaluate_model(model, dataset, args, mode='test'): # More eval. metrics than original evaluate() and evaluate()valid
    """
